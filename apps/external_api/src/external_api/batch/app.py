"""Typer batch commands for external API."""
...
from external_api.repositories.sample_repository import SampleRepository
from external_api.services.batch_service import BatchResult, BatchService

app = typer.Typer(help="external-api batch commands")
